...
*The maximim width of the sites like the one pictured above is 1,440 pixels. On a 4K display more than one thousand pixels occupy the space to the its right and left hand side. On a 5K display, almost two thousand pixels buffers each side.*

Since [2010](http://alistapart.com/article/responsive-web-design), savvy sites like [The Great Discontent](http://thegreatdiscontent.com) have been been built with fluid widths—whereby its grid, images, and text dynamically scale according to the width of the observing browser.
